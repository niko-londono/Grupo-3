...
namespace TrabajoFinalParqueos
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (las > ri && las > sas)
            {
                Console.WriteLine("El mayor flujo estuvo en la tanda de la Mañana: " + las);
            }
            else if (ri > las && ri > sas)
            {
                Console.WriteLine("El mayor flujo estuvo en la tanda de la Tarde: " + ri);
            }
            else
            {
                Console.WriteLine("El mayor flujo estuvo en la tanda de la Noche: " + sas);
            }
        }
    }
}
